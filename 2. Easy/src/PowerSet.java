...
public class PowerSet {
	...
	/*
	 * private static void printPowerSet(String inputString, int index, String
	 * currentString) { int n = inputString.length();
	 * 
	 * if (currentString != "") System.out.println(currentString);
	 * 
	 * for (int i = index + 1; i < n; i++) { currentString += inputString.charAt(i);
	 * printPowerSet(inputString, i, currentString); currentString =
