...
// https://www.youtube.com/watch?v=c3SAvcjWb1E (BEST Video tutorial)
...
public class Tree_TopViewOfBinaryTree {
    ...
    * In top view, we only take the first node of each list of nodes */
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            List<Integer> output = getTopView(root);
            printTree(output);
        }
    }
